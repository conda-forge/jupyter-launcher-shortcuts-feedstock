About jupyter-launcher-shortcuts
================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-launcher-shortcuts-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15053&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-launcher-shortcuts-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-launcher-shortcuts` can be installed with:

```
conda install jupyter-launcher-shortcuts
```

It is possible to list all of the versions of `jupyter-launcher-shortcuts` available on your platform with:
